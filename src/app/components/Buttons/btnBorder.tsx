  ...
  return (
    <div className='relative'>
      <button // Altere de input para button
        ...
        className='h-12 items-center text-sm flex w-auto cursor-pointer bg-transparent rounded-md border border-slate-800 bg-neutral-950 p-3.5 text-slate-100 transition-colors duration-500 placeholder:select-none  placeholder:text-neutral-500 focus:border-[#8678F9] focus:outline-none'
