...
export function CarouselSpacing() {
  return (
    <div className="w-full flex flex-col h-[50rem] md:h-[35rem] lg:h-[25rem] rounded-3xl shadow-xl shadow-gray-200/20 relative z-10 bg-white/10  dark:bg-preto/10 dark:shadow-indigo-950/5 ">
