  ...
  <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
    <div className="lg:col-span-5 lg:col-start-1">
      ...
      <div className="mb-8">
        ...
        Nós fornecemos a você uma conta de teste que pode ser configurada em segundos. Nosso principal foco é fornecer respostas a você o mais rápido possível.
        </p>
      </div>
      ...
      <blockquote className="relative">
        <svg className="absolute top-0 start-5 sm:start-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-200 dark:text-gray-800" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="relative z-10">
          <p className="text-xl italic text-gray-800 dark:text-white">
            Sem dúvidas foi uma das melhores experiências que eu já tive na minha vida.
          </p>
        </div>
        ...
        <ul className="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden dark:divide-gray-700">
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Usuários já inscritos na plataforma
            </p>
          </li>

          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 dark:text-gray-200">
              <svg className="flex-shrink-0 w-5 h-5 text-indigo-600 dark:text-indigo-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>
              23%
            </div>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
             Usuários que conquistam vagas de emprego
            </p>
          </li>
          ...
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Rate de certificados C2 - Nível Nativo de Inglês
            </p>
          </li>
          ...
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Aprendizado superior, mais rápido e melhor!
            </p>
          </li>
        </ul>
