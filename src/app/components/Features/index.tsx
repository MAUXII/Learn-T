...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <nav className="max-w-6xl mx-auto grid sm:flex gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs" role="tablist">
    <button type="button" className="hs-tab-active:bg-white/[.05] hs-tab-active:hover:border-transparent focus:ring-1 focus:ring-gray-600 w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active" id="tabs-with-card-item-1" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
      ...
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">All-in-one workspace</span>
    ...
    <button type="button" className="hs-tab-active:bg-white/[.05] focus:ring-1 focus:ring-gray-600 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" id="tabs-with-card-item-2" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
      ...
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">Automation on a whole new level</span>
    ...
    <button type="button" className="hs-tab-active:bg-white/[.05] focus:ring-1 focus:ring-gray-600 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" id="tabs-with-card-item-3" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
      ...
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">Solving problems for every team</span>
      ...
      <div className="max-w-[1140px] lg:pb-32 relative">
        ...
        <figure className="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto rounded-b-lg shadow-[0_2.75rem_3.5rem_-2rem_rgb(45_55_75_/_20%),_0_0_5rem_-2rem_rgb(45_55_75_/_15%)] dark:shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)]">
          <div className="relative flex items-center max-w-[50rem] bg-white border-b border-gray-100 rounded-t-lg py-2 px-24 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex justify-center items-center w-full h-full bg-gray-200 text-[.25rem] text-gray-800 rounded-sm sm:text-[.5rem] dark:bg-gray-700 dark:text-gray-200">www.preline.co</div>
          </div>
      ...
      <div className="max-w-[1140px] lg:pb-32 relative">
        ...
        <figure className="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto rounded-b-lg shadow-shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)]">
          <div className="relative flex items-center max-w-[50rem] bg-gray-800 border-b border-gray-700 rounded-t-lg py-2 px-24">
            ...
            <div className="flex justify-center items-center w-full h-full bg-gray-700 text-[.25rem] text-gray-200 rounded-sm sm:text-[.5rem]">www.preline.co</div>
          </div>

          <div className="bg-gray-800 rounded-b-lg">
            <img className="max-w-full h-auto rounded-b-lg" src="/rank-desktop.jpg" alt="Image Description" />
          </div>
        </figure>
