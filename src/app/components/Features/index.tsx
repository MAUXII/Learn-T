...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <nav className="max-w-6xl mx-auto grid sm:flex gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs" role="tablist">
    <button type="button" className="hs-tab-active:bg-white/[.05] hs-tab-active:hover:border-transparent focus:ring-1 focus:ring-gray-600 w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active" id="tabs-with-card-item-1" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
      ...
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">Tudo em um lugar só</span>
        <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Aprenda o inglês falado tudo em uma plataforma só, sem complicações</span>
      </span>
    </button>

    <button type="button" className="hs-tab-active:bg-white/[.05] focus:ring-1 focus:ring-gray-600 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" id="tabs-with-card-item-2" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
      <svg className="flex-shrink-0 hidden sm:block h-7 w-7 hs-tab-active:text-indigo-600 text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></svg>
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">Aumente o seu level</span>
        <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Um sistema de Rank saudável, incentivamos os alunos a estudarem cada vez mais!</span>
      </span>
    </button>

    <button type="button" className="hs-tab-active:bg-white/[.05] focus:ring-1 focus:ring-gray-600 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-indigo-700/10 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-indigo-700/10 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" id="tabs-with-card-item-3" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
      <svg className="flex-shrink-0 hidden sm:block h-7 w-7 hs-tab-active:text-indigo-600 text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
      <span className="mt-5">
        <span className="hs-tab-active:text-indigo-600 block font-semibold text-gray-800 dark:hs-tab-active:text-indigo-500 dark:text-gray-200">Respondendo suas dúvidas</span>
        <span className="hidden lg:block mt-2 text-gray-800 dark:text-gray-200">Agora temons uma nova feature, um IA Chatbot que irá tirar todas suas dúvidas</span>
      </span>
    </button>
  </nav>
