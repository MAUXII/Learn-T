export const Table = () =>{
    return(
        <div className="flex mt-12 sm:mt-10 md:-mt-6 lg:-mt-8 flex-col w-full">
    ...
    <div className="p-1.5 w-full inline-block align-middle">
      <div className="overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead>
            <tr>
              <th scope="col" className="px-6 py-3 text-center sm:text-start text-xs font-medium text-gray-500 uppercase">Nome</th>
              <th scope="col" className="px-6 py-3 text-center sm:text-start text-xs font-medium text-gray-500 uppercase">Idade</th>
              <th scope="col" className="px-6 py-3 text-center sm:text-start text-xs font-medium text-gray-500 uppercase">Aluno desde</th>
              <th scope="col" className="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase hidden sm:block">Socials</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                <button type="button" className="hidden sm:inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-indigo-600 hover:text-indigo-800 disabled:opacity-50 disabled:pointer-events-none dark:text-indigo-500 dark:hover:text-indigo-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Instagram</button>
              </td>
            </tr>
